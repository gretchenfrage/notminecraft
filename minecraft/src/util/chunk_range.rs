...
#[test]
fn chunk_range_diff_test() {
    for a_start_x in 1..=7 {
        for a_start_y in 1..=7 {
            for a_start_z in 1..=7 {
                let a_start = Vec3 {
                    x: a_start_x,
                    y: a_start_y,
                    z: a_start_z,
                ...
                for a_end_x in 1..=7 {
                    for a_end_y in 1..=7 {
                        for a_end_z in 1..=7 {
                            ...
                            for b_start_x in 1..=7 {
                                for b_start_y in 1..=7 {
                                    for b_start_z in 1..=7 {
                                        let b_start = Vec3 {
                                            x: b_start_x,
                                            y: b_start_y,
                                            z: b_start_z,
                                        ...
                                        for b_end_x in 1..=7 {
                                            for b_end_y in 1..=7 {
                                                for b_end_z in 1..=7 {
                                                    ...
                                                    let mut actual_diff = a.iter_diff(b)
